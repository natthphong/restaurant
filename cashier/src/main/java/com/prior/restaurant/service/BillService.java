...
public class BillService {
    ...
    public void getPdf(String uuid , HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            responseModel.setDescription("uuid not found");
            ObjectMapper objectMapper = new ObjectMapper();
            objectMapper.registerModule(new JavaTimeModule());
           String json =  objectMapper.writeValueAsString(responseModel);
